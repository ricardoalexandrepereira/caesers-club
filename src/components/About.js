...
const About = () => {
  ...
  return(
    <section className='lg:py-16 xl:pb-[60px]' id='about'>
      <div className="container mx-auto">
        <div className='flex flex-col lg:flex-row gap-x-[70px] items-center'>
          ...
          className='flex flex-col lg:flex-row flex-1'>
            <div className='text-[360px] xl:text-[720px] leading-none font-tertiary lg:-tracking-[0.155em] bg-about bg-no-repeat bg-top bg-clip-text text-transparent'>014</div>
          </motion.div>
